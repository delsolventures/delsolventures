      ...
      <main className="text-trueGray-700">
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage:
                "url('https://storageapi.fleek.co/20626237-8360-4375-83b2-2294cdded30d-bucket/img/doodleipsum-ed98837bc0b91d677c167bd1957ca1a6.png')"
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div className="pr-12">
                  <Text
                    h1
                    className="uppercase text-white font-semibold text-5xl"
                  >
                    Terms & Conditions
                  </Text>
        ...
        <section className="relative py-20 text-trueGray-700">
            ...
            <div className="items-center flex flex-wrap">
              <div className="w-full  ml-auto mr-auto px-4">
                ...
                <Text>
                  ...
                  Offerings, all users are required to accept and comply with
                  these Terms of Use. You agree that by accessing the Site
                  and/or the Marketplace Offerings, you have read, understood,
                  ...
                  IMMEDIATELY. Supplemental terms and conditions or documents
              ...
              <Collapse.Group splitted className="text-trueGray-700">
                ...
                >
                  ...
                  <Text className="text-trueGray-700">
                    ...
                    Site or the Marketplace Offerings and no Content or Marks
                    ...
                    express prior written permission. Provided that you are
                    eligible to use the Site, you are granted a limited license
                    to access and use the Site and to download or print a copy
                ...
                >
                  <Text className="text-trueGray-700">
                    ...
                    not a minor in the jurisdiction in which you reside; (3) you
                    will not access the Site or the Marketplace Offerings
                    through automated or non-human means, whether through a bot,
                    script or otherwise; (4) you will not use the Site for any
                    ...
                    refuse any and all current or future use of the Site (or any
                    portion thereof). You may not use the Site or the
                    Marketplace Offerings for any illegal or unauthorized
                    purpose nor may you, in the use of Marketplace Offerings,
                    violate any laws. Among unauthorized Marketplace Offerings
                    are the following: intoxicants of any sort; illegal drugs or
                    other illegal products; alcoholic beverages; games of
                    chance; and pornography or graphic adult content, images, or
                    other adult products. Postings of any unauthorized products
                    or content may result in immediate termination of your
                    account and a lifetime ban from use of the Site. We are a
                    service provider and make no representations as to the
                    safety, effectiveness, adequacy, accuracy, availability,
                    prices, ratings, reviews, or legality of any of the
                    information contained on the Site or the Marketplace
                    Offerings displayed or offered through the Site. You
                    understand and agree that the content of the Site does not
                    contain or constitute representations to be reasonably
                    relied upon, and you agree to hold us harmless from any
                    errors, omissions, or misrepresentations contained within
                ...
                <Collapse title="MARKETPLACE OFFERINGS">
                  <Text>
                    ...
                    discretion. We reserve the right to discontinue any
                    Marketplace Offerings at any time for any reason. We do not
                ...
                <Collapse title="PURCHASES AND PAYMENT">
                  ...
                  <Text>
                    ...
                    expiration date, so that we can complete your transactions
                    and contact you as needed. Sales tax will be added to the
                    ...
                    have already requested or received payment. We reserve the
                    right to refuse any order placed through the Site. We may,
                    in our sole discretion, limit or cancel quantities purchased
                    per person, per household, or per order. These restrictions
                    may include orders placed by or under the same customer
                    account, the same payment method, and/or orders that use the
                ...
                <Collapse title="PROHIBITED ACTIVITIES">
                  <Text>
                    ...
                    <ol>
                      ...
                      <li>
                        14. Use the Marketplace Offerings as part of any effort
                ...
                <Collapse title="CONTRIBUTION LICENSE">
                  <Text>
                    ...
                    share such feedback for any purpose without compensation to
                    you. We do not assert any ownership over your Contributions.
                ...
                <Collapse title="SUBMISSIONS">
                  <Text>
                    ...
                    provided by you to us are non-confidential and shall become
                    our sole property. We shall own exclusive rights, including
                    all intellectual property rights, and shall be entitled to
                    the unrestricted use and dissemination of these Submissions
                ...
                <Collapse title="TERM AND TERMINATION">
                  <Text>
                    ...
                    reason, you are prohibited from registering and creating a
                    new account under your name, a fake or borrowed name, or the
                ...
                <Collapse title="MODIFICATIONS AND INTERRUPTIONS">
                  <Text>
                    ...
                    the Site or the Marketplace Offerings. We cannot guarantee
                    the Site and the Marketplace Offerings will be available at
                    ...
                    or otherwise modify the Site or the Marketplace Offerings at
                    any time or for any reason without notice to you. You agree
                    that we have no liability whatsoever for any loss, damage,
                    or inconvenience caused by your inability to access or use
                    the Site or the Marketplace Offerings during any downtime or
                    discontinuance of the Site or the Marketplace Offerings.
                    Nothing in these Terms of Use will be construed to obligate
                    us to maintain and support the Site or the Marketplace
                    Offerings or to supply any corrections, updates, or releases
                    in connection therewith. GOVERNING LAW These Terms of Use
                    and your use of the Site and the Marketplace Offerings are
                ...
                <Collapse title="DISPUTE RESOLUTION">
                  ...
                  <Text>
                    ...
                    America, Delaware. Except as otherwise provided herein, the
                    ...
                    rather than arbitration, the Dispute shall be commenced or
                    prosecuted in the state and federal courts located in United
                    States of America, Delaware, and the Parties hereby consent
                    ...
                    Terms of Use. If this provision is found to be illegal or
                ...
                <Collapse title="DISCLAIMER">
                  <Text>
                    ...
                    EXPRESS OR IMPLIED, IN CONNECTION WITH THE SITE AND THE
                    MARKETPLACE OFFERINGS AND YOUR USE THEREOF, INCLUDING,
                    ...
                    OR CESSATION OF TRANSMISSION TO OR FROM THE SITE OR THE
                    MARKETPLACE OFFERINGS, (5) ANY BUGS, VIRUSES, TROJAN HORSES,
                ...
                <Collapse title="LIMITATIONS OF LIABILITY">
                  <Text>
                    ...
                    OR THE MARKETPLACE OFFERINGS, EVEN IF WE HAVE BEEN ADVISED
                    ...
                    ANY, BY YOU TO US DURING THE ONE (1) MONTH PERIOD PRIOR TO
                    ...
                    any loss, damage, liability, claim, or demand, including
                    reasonable attorneys’ fees and expenses, made by any third
                    party due to or arising out of: (1) use of the Marketplace
                    Offerings; (2) breach of these Terms of Use; (3) any breach
                    ...
                    of the Site or the Marketplace Offerings with whom you
                    ...
                    becoming aware of it. USER DATA We will maintain certain
                    data that you transmit to the Site for the purpose of
                    managing the performance of the Marketplace Offerings, as
                    well as data relating to your use of the Marketplace
                    Offerings. Although we perform regular routine backups of
                    data, you are solely responsible for all data that you
                    transmit or that relates to any activity you have undertaken
                    using the Marketplace Offerings. You agree that we shall
                    ...
                    952-5210 or (916) 445-1254. MISCELLANEOUS These Terms of Use
                    and any policies or operating rules posted by us on the Site
                    or in respect to the Marketplace Offerings constitute the
                    ...
                    Terms of Use or use of the Marketplace Offerings. You agree
