              ...
              <Collapse.Group splitted className="text-trueGray-700">
                ...
                <Collapse title="7. DO WE COLLECT INFORMATION FROM MINORS?">
                  <p className="text-sm">
                    ...
                    contact us at legal@delsolventures.nft.
                  </p>
                </Collapse>
                ...
                <Collapse title="10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?">
                  ...
                  <p className="text-sm">
                    ...
                    may contact us by email at legal@delsolventures.nft, by
                    visiting
                  </p>
                  <Link
                    className="text-sm font-bold"
                ...
                <Collapse title="12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?">
                  <p className="text-sm">
                    ...
                    email us at legal@delsolventures.nft or by post to:
                  </p>
                  <p className="text-sm">
