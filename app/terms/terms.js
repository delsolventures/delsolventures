...
export default function Terms() {
  return (
    <main className="mx-auto">
      <div className="hero min-h-[250px]">
          ...
          <div className="flex flex-wrap items-center">
            <div className="ml-auto mr-auto w-full px-4">
              <div className="text-sm">
                ...
                “we”, “us”, or “our”), concerning your access to and use of this
                ...
                these Terms of Use. You agree that by accessing the Site and/or
                the Marketplace Offerings, you have read, understood, and agree
                ...
                conditions or documents that may be posted on the Site from time
            ...
            <div
              tabIndex={0}
              className="collapse-arrow collapse my-2 rounded-md bg-neutral focus:bg-primary"
            >
              ...
              <div className="collapse-content text-xs">
                ...
                <p>
                  ...
                  provided in these Terms of Use, no part of the Site or the
                  Marketplace Offerings and no Content or Marks may be copied,
            ...
            <div
              tabIndex={1}
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">USER REPRESENTATIONS</div>
              <div className="collapse-content text-xs">
                <p>
                  By using the Site or the Marketplace Offerings, you represent
                  and warrant that: (1) you have the legal capacity and you
                  agree to comply with these Terms of Use; (2) you are not a
                  minor in the jurisdiction in which you reside; (3) you will
                  not access the Site or the Marketplace Offerings through
                  automated or non-human means, whether through a bot, script or
                  otherwise; (4) you will not use the Site for any illegal or
                  unauthorized purpose; and (5) your use of the Site or the
                  Marketplace Offerings will not violate any applicable law or
                  ...
                  availability, prices, ratings, reviews, or legality of any of
                  the information contained on the Site or the Marketplace
                  ...
                  upon, and you agree to hold us harmless from any errors,
                  omissions, or misrepresentations contained within the Site’s
                  content. We do not endorse or recommend any Marketplace
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">MARKETPLACE OFFERINGS</div>
              <div className="collapse-content text-xs">
                <p>
                  We reserve the right to limit the quantities of the
                  Marketplace Offerings offered or available on the Site. All
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">PURCHASES AND PAYMENT</div>
              <div className="collapse-content text-xs">
                <p>
                  {" "}
                  We accept the following forms of payment: Crypto-Currency Bank
                ...
                <p>
                  ...
                  payments shall be in U.S. dollars. You agree to pay all
                  ...
                  received payment. We reserve the right to refuse any order
                  placed through the Site. We may, in our sole discretion, limit
                  or cancel quantities purchased per person, per household, or
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">REFUNDS POLICY</div>
              <div className="collapse-content text-xs">
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">PROHIBITED ACTIVITIES</div>
              <div className="collapse-content text-xs">
                <p>
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">USER GENERATED CONTRIBUTIONS</div>
              <div className="collapse-content text-xs">
                <p>
                  {" "}
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">CONTRIBUTION LICENSE</div>
              <div className="collapse-content text-xs">
                <p>
                  {" "}
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">SOCIAL MEDIA</div>
              <div className="collapse-content text-xs">
                <p>
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">SUBMISSIONS</div>
              <div className="collapse-content text-xs">
                <p>
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">SITE MANAGEMENT</div>
              <div className="collapse-content text-xs">
                <p>
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">PRIVACY POLICY</div>
              <div className="collapse-content text-xs">
                <p>
                ...
                <p>
                  ...
                  these Terms of Use. Please be advised the Site and the
                  Marketplace Offerings are hosted in the United States. If you
                  access the Site or the Marketplace Offerings from any other
                  ...
                  the United States, and you agree to have your data transferred
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">TERM AND TERMINATION</div>
              <div className="collapse-content text-xs">
                <p>
            ...
            >
              ...
              <div className="collapse-content text-xs">
                <p>
                  ...
                  Offerings will be available at all times. We may experience
                  ...
                  update, suspend, discontinue, or otherwise modify the Site or
                  the Marketplace Offerings at any time or for any reason
                  ...
                  updates, or releases in connection therewith. GOVERNING LAW
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">DISPUTE RESOLUTION</div>
              <div className="collapse-content text-xs">
                ...
                <p>
                  ...
                  will take place in United States of America, Delaware. Except
                  as otherwise provided herein, the Parties may litigate in
                  ...
                  courts located in United States of America, Delaware, and the
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">CORRECTIONS</div>
              <div className="collapse-content text-xs">
                <p>
                  {" "}
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">DISCLAIMER</div>
              <div className="collapse-content text-xs">
                <p>
                  ...
                  MARKETPLACE OFFERINGS AND YOUR USE THEREOF, INCLUDING, WITHOUT
                  ...
                  OR THE MARKETPLACE OFFERINGS, (5) ANY BUGS, VIRUSES, TROJAN
                  HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE
                  SITE BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">LIMITATIONS OF LIABILITY</div>
              <div className="collapse-content text-xs">
                <p>
                  ...
                  Marketplace Offerings; (2) breach of these Terms of Use; (3)
                  ...
                  user of the Site or the Marketplace Offerings with whom you
                  ...
                  which is subject to this indemnification upon becoming aware
                  of it. USER DATA We will maintain certain data that you
                  transmit to the Site for the purpose of managing the
                  performance of the Marketplace Offerings, as well as data
                  relating to your use of the Marketplace Offerings. Although we
                  ...
                  BY US OR VIA THE SITE. You hereby waive any rights or
                  ...
                  means other than electronic means. CALIFORNIA USERS AND
                  ...
                  or use of the Marketplace Offerings. You agree that these
            ...
            <div
              ...
              className="collapse collapse-arrow bg-neutral text-primary-content focus:bg-primary my-2 rounded-md"
            >
              <div className="collapse-title">CONTACT US</div>
              <div className="collapse-content text-xs">
                <p>
