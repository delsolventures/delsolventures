        ...
        <div className="container mx-auto px-8">
          <div className="flex flex-wrap items-center">
            <div className="mx-auto w-full px-4">
              <div
                tabIndex={0}
                className="collapse collapse-arrow bg-neutral focus:bg-primary my-2 rounded-md"
              >
                <div className="collapse-title">1. GENERAL NOTICE</div>
                <div className="collapse-content text-xs">
                  Thank you for choosing to be part of our community at del SOL
                  VENTURES INC., doing business as del SOL (&quot; del
                  SOL,&quot; &quot;we,&quot; &quot;us,&quot; or
                  ...
                  contact us at delsol@skiff.com. This privacy notice describes
                  how we might use your information if you visit our website.
                </div>
              </div>
              <div
                tabIndex={1}
              ...
              >
                ...
                <div className="collapse-content text-xs">
                  <p>
                    ...
                    contact us at legal@delsol.nft.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="collapse-content text-xs">
                  <p>
                    ...
                    <span>
                      <Link
                        href="https://commission.europa.eu/about-european-commission/contact/problems-and-complaints_en"
                        target="_blank"
                      >
                        European Commission
                      </Link>
              ...
              >
                ...
                <div className="collapse-content text-xs">
                  ...
                  <p>
                    ...
                    may contact us by email at legal@delsol.nft, by visiting
                    <span>
              ...
              >
                ...
                <div className="collapse-content text-xs">
                  <p>
                    ...
                    email us at legal@delsol.nft or by post to:
                  </p>
                  <p>
